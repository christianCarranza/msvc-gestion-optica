...
create table categorias(
	...
	usuario_modificación 	varchar(36),
...
insert into categorias(id_categoria, nombre, url, imagen, icono, vista, estado, usuario_creacion, fecha_creación, usuario_modificación, fecha_modificacion)
...
insert into sub_categoria_titulos(id_sub_categoria_titulo, id_categoria, descripcion, estado, usuario_creacion, fecha_creación, usuario_modificación, fecha_modificacion)
...
insert into sub_categorias(id_sub_categoria, id_sub_categoria_titulo, nombre, url , imagen , inventario, vista, estado , usuario_creacion, fecha_creación, usuario_modificacion, fecha_modificacion)
...
insert into productos(id_producto, id_sub_categoria, nombre, palabra_clave, url ,imagen, precio, stock, id_cupon, id_promocion, especificaciones, detalles, descripcion, default_banner, vertical_slider, estado, usuario_creacion, fecha_creación, usuario_modificacion, fecha_modificacion)
